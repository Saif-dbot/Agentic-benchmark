...
class CrewAIAdapter(AgentAdapter):
    ...
    def _run_real_mode(self, task: dict[str, Any], prompt: str, started: float) -> dict[str, Any]:
    ...
    def run(self, task: dict[str, Any], config: dict[str, Any]) -> dict[str, Any]:
        ...
        if mode == "real":
            try:
                return self._run_real_mode(task, prompt, started)
        ...
        response = (
            "[MOCK-CREWAI] Reponse simulee par roles. "
